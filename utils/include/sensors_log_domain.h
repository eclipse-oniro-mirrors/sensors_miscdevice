...
constexpr uint32_t MISCDEVICE_SERVICE = 0xD002751;
constexpr uint32_t MISCDEVICE_FWK = 0xD002752;
constexpr uint32_t MISCDEVICE_LIGHT_JNI = 0xD002753;
constexpr uint32_t MISCDEVICE_VIBRATOR_JNI = 0xD002754;
constexpr uint32_t MISCDEVICE_LIGHT_NATIVE = 0xD002755;
constexpr uint32_t MISCDEVICE_VIBRATOR_NATIVE = 0xD002756;
constexpr uint32_t MISCDEVICE_VIBRATOR_INTERFACE = 0xD002757;
}  // namespace SensorsLogDomain
}  // namespace OHOS
